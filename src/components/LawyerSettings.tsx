  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            <Label htmlFor="consultation-rate">Consultation Rate (per hour)</Label>
            <Input id="consultation-rate" placeholder="₹500" />
          </div>
          <div>
            <Label htmlFor="availability">Available Hours</Label>
            <Input id="availability" placeholder="9:00 AM - 6:00 PM" />
          </div>
